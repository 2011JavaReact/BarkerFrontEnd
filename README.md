...
- Expand dog preferences that are applied to dogs viewable in the 'swipe' page to include age, size, good-with, coat length, and energy level preferences.
...
- Click Growl (Dislike) to remove dog from list of available dogs (logged in user only).
...
- Review list of dogs along with the shelter where they are located.
...
- Click on Barker Logo to return to shelter menu.
- Add dog to be viewable by users seeking to adopt.
- View list of dogs previously added.
- Click on shelter name to modify shelter details.
...
- Select gender, shedding level, and energy levels from drop down menus.
